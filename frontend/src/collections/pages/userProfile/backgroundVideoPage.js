...
//       fetchUserImage(decodedToken.id);
//     }
//   }, []);
...
//   //   try {
//   //     const response = await axios.get(`http://localhost:8080/user/byId/${userId}`);
//   //     setUserData({ 
//   //       id: response.data.id, 
...
//   //       departmentRole: response.data.role 
//   //     });
//   //   } catch (error) {
//   //     console.log('Error fetching user data:', error);
//   //   }
...
//   //   try {
//   //     const response = await fetch(`http://localhost:8080/profile/getProfImage/${userId}`);
//   //     if (!response.ok) {
...
//       // Assuming response contains the new image URL, update the profile image
