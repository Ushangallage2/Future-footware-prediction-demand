...
const Table = (props) => {
    ...
    const canAddUser = newUser.fName && newUser.lName && newUser.email && newUser.role && newUser.username && newUser.password && !error.email && !error.password;

// Condition for enabling the save button when editing a user
const canEditUser = editUser && editUser.fName && editUser.lName && editUser.email && editUser.role && editUser.username && !error.email;
        ...
        <div className={`fade-in ${fadeIn ? 'visible' : ''}`}>
            ...
            /> */}
                        ...
                        <div style={{ marginTop: '20px', textAlign: 'right' }}>
                           ...
                           <Button 
    onClick={editUser ? handleSaveEditedUser : handleAddUser} 
    color="primary" 
    disabled={editUser ? !canEditUser : !canAddUser}
>
    {editUser ? 'Save' : 'Add User'}
       </Button>
                        </div>
